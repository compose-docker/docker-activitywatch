...
ADD https://github.com/ActivityWatch/activitywatch/releases/download/v0.13.2/activitywatch-v0.13.2-linux-x86_64.zip /app
...
RUN cd /app && unzip activitywatch-v0.13.2-linux-x86_64.zip
